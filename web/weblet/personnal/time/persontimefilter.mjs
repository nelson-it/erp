...
//
// datei: weblet/personnal/time/persontimefilter.mjs
//================================================================================
'use strict';
...
class MneErpPersonnalPersontimefilter extends MneDbView
{
  ...
  get wcol() { return this.initpar.starttimename + "," + this.initpar.starttimename + ',personid'; }
  get wop()  { return ">=,<,="; }
  get wval() { return this.obj.inputs.startdate.getValue() + "," + (this.obj.inputs.enddate.getValue() + 86400) + ',' + this.obj.inputs.personid.getValue(); }
...
export default MneErpPersonnalPersontimefilter;
