...
//
// datei: weblet/builddiary/ordertimefilter.mjs
//================================================================================
'use strict';
...
class MneErpBuilddiaryOrdertimefilter extends MneDbView
{
  ...
  get wcol() { return 'orderid,timeid,typ'; }
  get wop()  { return "=,=,="; }
  get wval() { return this.obj.inputs.orderid.getValue() + ',' + this.obj.inputs.timeid.getValue() + ',' + this.obj.inputs.typ.getValue(); }
